...
async function eden(prompt) {
    const dir_history_chat = `database/data_chat/data_chat_wdqk`;
    ...
    if(prompt == "reset"){
        ...
        const response = await reqEden(config, chatHistory, prompt, config.GLOBAL_CHAT_WDQK)
